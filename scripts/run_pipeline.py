...
Now also writes: outputs/alerts.csv with total & per-category cap status.
Optionally sends Email/Telegram alerts if --notify is set and env vars are configured.

Usage:
  python scripts/run_pipeline.py --input data/sample_transactions.csv --output outputs
  python scripts/run_pipeline.py --input data/sample_transactions.csv --output outputs --notify
"""
